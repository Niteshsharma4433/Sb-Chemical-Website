const AboutSectionAni = () => {
    return (
        <div className="flex min-h-[100%] w-11/12 mx-auto py-12 xl:mt-12 items-center justify-center flex-col">
            <h2 className="font-bold text-4xl">About us</h2>
            <div className="flex xl:flex-row flex-col items-center  w-full gap-8 justify-center">
                <div className="xl:w-[50%] w-full h-full xl:mt-20 p-8 rounded-md flex flex-col justify-start items-start gap-8">
                ...
                <div className="dee  h-[50%] -mt-16 xl:py-0 py-16">
...
export default AboutSectionAni;