...
const HeroSection = () => {
  return (
    <>
      <div className="relative  h-[100%] w-[100%] top-0 bottom-0 z-auto mix-blend-lighten "></div>
      <video
        src={video}
        className="absolute z-auto sm:h-[100vh] xs:h-[100vh] w-[100%] top-0 bottom-0 left-0 right-0 object-cover"
        type="video/mp4"
        autoPlay
        loop
        muted
      ></video>
      <div className="px-[1.5rem] text-white w-full max-h-max pt-[1rem] relative h-[100vh] flex gap-12 flex-col items-stretch justify-center m-auto z-[100]">
